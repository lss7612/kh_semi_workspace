...
/**
 * Servlet implementation class SendNoteBinView
 */
@WebServlet("/note/sendNoteBinView")
public class SendNoteBinViewController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		req.getRequestDispatcher("/views/noteViews/sendNoteBinView.jsp").forward(req, resp);
