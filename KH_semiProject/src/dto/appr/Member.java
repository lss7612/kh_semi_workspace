...
public class Member {
	...
	public String toString() {
		return "Login [user_no=" + user_no + ", user_name=" + user_name + ", user_grade=" + user_grade + ", user_addr="
				+ user_addr + ", user_identify=" + user_identify + ", dept_no=" + dept_no + ", position_no="
				+ position_no + ", cellphone_no=" + cellphone_no + ", extention_no=" + extention_no + ", user_id="
				+ user_id + ", user_pw=" + user_pw + ", user_notice=" + user_notice + ", state_no=" + state_no
				+ ", revision_date=" + revision_date + ", user_ip=" + user_ip + ", table_no=" + table_no + "]";
	}
	...
	public String getExtention_no() {
		return extention_no;
	}
	public void setExtention_no(String extention_no) {
		this.extention_no = extention_no;
	}
