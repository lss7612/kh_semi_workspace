...
<tr>
  ...
  <tr>
    ...
    <td align="center" class="form10"><div id="username"></div></td>
  ...
  <tr>
    ...
    <td width="188" align="center" class="form10"><div tms_edit id="jic2"></div></td>
    <td width="79" align="center" bgcolor="#D9E2F3" class="form10b">부서(팀)</td>
    <td width="182" align="center" class="form10"><div id="partname"></div></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <table width="100%" border="0"  class="form10">
      <tr>
        ...
        <td align="center"><div  id="aa2" onClick="gb(this)">조퇴(&nbsp;&nbsp;&nbsp;)</div></td>

        <td align="center"><div  id="aa7" onClick="gb(this)">반차(&nbsp;&nbsp;&nbsp;)</div></td>
      </tr>
    </table></td>
  </tr>
  <tr>
