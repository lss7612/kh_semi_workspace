...
public class ApprovalMyDaoImpl implements ApprovalMyDao {
	...
	@Override
	public int selectCntAllapprove(Connection connection, ApprMy apprMy) {
		// TODO Auto-generated method stub
		...
		sql+="select count(*) from\r\n" + 
				...
				"(select a.aprvl_no,a.aprvl_state,a.user_no,b.user_name,a.create_date,a.final_date,a.aprvl_title,a.aprvl_type from tb_approval a,tb_user b where a.user_no=b.user_no) b\r\n" + 
				",tb_approvalstate c\r\n" + 
				"where a.USER_no=b.USER_no and b.aprvl_state=c.state_no and a.user_id=? and b.aprvl_state=? order by b.aprvl_no desc)";
		...
		try {
			...
			ps.setString(1, apprMy.getUser_id());
			ps.setInt(2, apprMy.getAprvl_state());
			rs = ps.executeQuery();
	...
	@Override
	public List<ApprMy> selectApproveList(Connection connection, ApprMy apprMy, Paging_app paging) {
