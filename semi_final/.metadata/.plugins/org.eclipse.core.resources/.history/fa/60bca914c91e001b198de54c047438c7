...
public class AdLoginDao {
	   ...
	   public ArrayList<AdLogin> getListMember(){
	      
	      ArrayList<AdLogin> list = new ArrayList<AdLogin>();
...
//	      sql += " WHERE A.USER_GRADE=2";
	      ...
	      try {
	          pstmt =conn.prepareStatement(sql);
	            ...
	            while(rs.next()) {
	               ...
	               AdLogin vo = new AdLogin(user_id, user_pw, user_name, user_grade);
	   ...
	   public String adLoginCheck(String user_id, String user_pw) {
	    ...
	    public String adLoginCheck(String user_id, String user_pw, int user_grade) {
	      ...
	      //로그인체크
	       ...
	       try {
	         ...
	         if(rs.next()) {
	            user_name = rs.getString("user_name");
	            System.out.println("user_nmae : 111111111111111"+ user_name);
	         }
	       } catch (Exception e) {
	         e.printStackTrace();
	       } finally {
