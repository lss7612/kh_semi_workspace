			...
			<form id="sendNote" action="/note/send" method="GET">
				<table class="table-hover table-striped">
					...
					<tbody>
						...
						%>
						<tr class="">
							<td class="checkbox"><input type="checkbox" name="receiver_no<%=i%>"
								value="<%=list.get(i).getUser_no()%>"></td>
							...
							<td class="user_name"><span class="users"><%=list.get(i).getUser_name()%></span>
							</td>
							<td class="user_id"><%=list.get(i).getUser_id()%></td>
							<td class="cellphone_no"><%=list.get(i).getCellphone_no()%></td>
							<td class="tdchat"><span class="chat" >채팅하기</span></td>
						</tr>
						<%
							}
						%>
						...
						<tr>
							<td><span class="sendNote">쪽지하기</span></td>
							<td></td>
							<td></td>
							<td></td>
							<td></td>
