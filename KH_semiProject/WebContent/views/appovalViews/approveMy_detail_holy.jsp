...
<form action="/approval/myDetail" method="post">
	...
	<table>
		...
		<tr>
			<th>시작날짜</th><td><input type="text" name="final_auth" id="final_auth" readonly="readonly" value="<%=list.get(0).getHoliday_start() %>"/></td>
			<th>끝날짜</th><td><input type="text" name="final_auth" id="final_auth" readonly="readonly" value="<%=list.get(0).getHoliday_end() %>"/></td>
