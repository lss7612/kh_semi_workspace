 ...
 */
@WebServlet("/note/receiveview")
public class RecievedViewController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {   
		...
		req.getRequestDispatcher("/views/noteViews/receivedNoteView.jsp").forward(req, resp);
